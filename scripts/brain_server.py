    ...
    FIRST_HANDOFF_PATH.write_text(
        "\n".join(
            [
                ...
                "Run `git status --short --branch` to establish repo reality before planning.",
                "If the working tree is not clean, treat this session as continuation work and override inherited clean-slate/bootstrap assumptions when repo reality disagrees.",
                ...
                "Keep execution local-first, deterministic, and document each slice in brain files.",
                "",
                "## Ready-To-Paste Prompt",
                f"You are {lead} continuing in `{ROOT.name}`.",
                f"Lead with: {role_desc}.",
                f"Mission focus: {mission}",
                "Start with `git status --short --branch`; if the tree is not clean, treat this as continuation work and override inherited clean-slate/bootstrap assumptions.",
                "Use `G-Codex-brain/ROADMAP.md` as the canonical source-of-truth before making changes.",
